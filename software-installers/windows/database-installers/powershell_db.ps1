...
$scriptUrl = "https://raw.githubusercontent.com/tinitiateprime/tinitiate-onboarding/main/software-installers/windows/database-installers/common_softs_for_db.ps1"
$scriptPath = "$env:TEMP\downloaded_script1.ps1"
